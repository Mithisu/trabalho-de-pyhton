...
from jogador import Jogador  # Funções para criar e mover o jogador, e verificar interações
...
def fase2():
    ...
    jogador = Jogador(WORLD_WIDTH, WORLD_HEIGHT)  # Cria o jogador e define sua velocidade
